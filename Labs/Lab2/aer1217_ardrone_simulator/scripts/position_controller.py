...
class PositionController(object):
    ...
    def __init__(self):
        ...
        self.x_old = 0.0;        self.x_err_old = 0.0
        self.y_old = 0.0;        self.y_err_old = 0.0
        self.z_old = 0.0;        self.z_err_old = 0.0
        self.yaw_old = 0.0;      self.yaw_err_old = 0.0
        self.z_dot_old = 0.0

        # PD parameters
        self.kp_xy = 1.3  # Kp for x and y controller
    ...
    def dynamics_ctrl_cal(self, data, des_pos, dt):
        ...
        self.x_old = x_cur;        self.x_err_old = x_err
        self.y_old = y_cur;        self.y_err_old = y_err
        self.z_old = z_cur;        self.z_err_old = z_err
        self.yaw_old = yaw_cur;    self.yaw_err_old = yaw_err
